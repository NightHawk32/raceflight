...
#elif defined(STM32F303xC) && !defined(MOTOLAB) && !defined(LUX_RACE) && !defined(PIKOBLX)
    switch (lpf) {
		case 0:
        	gyroSamplePeriod = 125;
...
#elif defined(STM32F40_41xxx) || defined(STM32F411xE) || defined(MOTOLAB) || defined(LUX_RACE) || defined(PIKOBLX)
    switch (lpf) {
		case 0:
		case 1:
		case 2:
